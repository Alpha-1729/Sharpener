...
function ComposeEmailModal({ show, handleClose }) {
    ...
    const sendEmailHandler = async () => {
        ...
        try {
            ...
            const { outboxResponse, outboxError } = await addEmailToOutbox(userEmail, outboxObj);

            // dispatch(emailActions.addOutboxEmail({
            //     id: outboxResponse.name,
            //     ...outboxObj
            // }));
            ...
            const { inboxResponse, inboxError } = await addEmailToInbox(recipientEmail, inboxObj);

            // dispatch(emailActions.addInboxEmail({
            //     id: inboxResponse.name,
            //     ...inboxObj
